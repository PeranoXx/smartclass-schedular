...
<body class="text-gray-800 font-inter">
    ...
    <div class="fixed left-0 top-0 w-72 h-full bg-[#f8f4f3] p-4 pt-5 z-50 sidebar-menu transition-transform">
        ...
        <ul class="mt-4">
            <li class="mb-1 group">
                <a href="" class="flex gap-2 font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100  group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
