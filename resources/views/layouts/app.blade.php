...
<body class="text-gray-800 font-inter">
    <!--sidenav -->
    <div class="fixed left-0 top-0 w-72 h-full bg-[#f8f4f3] p-4 pt-5 z-50 sidebar-menu transition-transform">
        ...
        <ul class="mt-4">
            ...
            <li class="mb-1 group">
              <a href="{{route('sign-up')}}"  class="flex gap-2 font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 hover:drop-shadow-lg hover:scale-110 transition-all  group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
            ...
            <ul class="ml-auto flex items-center">
                ...
                <li class="dropdown ml-3">
                    ...
                    <ul class="dropdown-menu shadow-md shadow-black/5 z-30 hidden py-1.5 rounded-md bg-white border border-gray-100 w-full max-w-[140px]">
                        <li>
                            <a href="{{route('institute.profile')}}" class="flex items-center text-[13px] py-1.5 px-4 text-gray-600 hover:text-[#f84525] hover:bg-gray-50">Profile</a>
                        </li>
                        <li>
