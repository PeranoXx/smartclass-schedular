<div>
    ...
    <div class="flex justify-end">
            ...
            <x-button class="mt-1" onclick="window.location='{{ route('user-management.user') }}'">Create user</x-button>
        </div>
    {{-- </a> --}}
                    ...
                    <x-table.row>
                        ...
                        <x-table.cell>
                            <div class="flex gap-x-4 items-center">
                                ...
                                <x-button class="px-12" onclick="window.location='{{route('assign-user-subject.index', ['id' => $data->id])}}'">Assign Subject</x-button>
                            </div>
                        </x-table.cell>
                    </x-table.row>
                    @endforeach
