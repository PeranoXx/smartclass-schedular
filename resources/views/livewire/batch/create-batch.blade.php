<div>
    <div class="flex justify-end">
        <x-button onclick="Livewire.dispatch('openModal', { component: 'batch.batch-management-modal' })" class="mt-1"> Create
            Batch </x-button>
    </div>
            ...
            <x-table>
                <x-slot name="head">
                    ...
                    <x-table.heading wire:click="sortBy('name')"
                        :direction="$sortField == 'name' ? $sortDirection : null" sortable>Class</x-table.heading>
                    <x-table.heading wire:click="sortBy('name')"
                        :direction="$sortField == 'name' ? $sortDirection : null" sortable>Batch</x-table.heading>
                    ...
                    <x-table.row>
                        ...
                        <x-table.cell>
                            <div class="flex gap-x-4">
                                <button 
                                    onclick="Livewire.dispatch('openModal', { component: 'batch.batch-management-modal', arguments: { batch_id: {{ $data->id }} , name: '{{$data->name}}' }})"
                                    class="">
