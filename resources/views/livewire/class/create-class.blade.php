<div>
    <div class="flex justify-end">
        <x-button onclick="Livewire.dispatch('openModal', { component: 'class.class-management-modal' })" class="mt-1"> Create
            Classroom </x-button>
    </div>
                    ...
                    <x-table.row>
                        ...
                        <x-table.cell>
                            <div class="flex gap-x-4">
                                <button
                                    onclick="Livewire.dispatch('openModal', { component: 'class.class-management-modal', arguments: { class_id: {{ $data->id }} , name: '{{$data->name}}' }})"
                                    class="">
                                ...
                                <x-button class="px-4" onclick="window.location='{{route('assign-subject.index', ['id' => $data->id])}}'">
                                        Assign Subject
                                </x-button>
                            </div>
                        </x-table.cell>
