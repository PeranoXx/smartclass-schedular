<div>
    <div class="flex justify-end">
        <x-button onclick="Livewire.dispatch('openModal', { component: 'batch-management-modal' })" class="mt-1"> Create
            Batch </x-button>
    </div>
                    ...
                    <x-table.row>
                        ...
                        <x-table.cell>
                            <div class="flex gap-x-4">
                                <button 
                                    onclick="Livewire.dispatch('openModal', { component: 'batch-management-modal', arguments: { batch_id: {{ $data->id }} , name: '{{$data->name}}' }})"
                                    class="">
