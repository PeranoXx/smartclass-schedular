        ...
        <div class="p-5 text-center">
            ...
            <form wire:submit.prevent="update" class="max-w-4xl mx-auto my-8">
                <div class="grid grid-cols-2 gap-5">
                    ...
                    <div>
                        <x-input label="Username" name="name" wire:model="username" />
                    ...
                    <div class="">
                        <x-input label="Father name" wire:model="father_name"></x-input>
                        @error('father_name') <span class="text-pink-500 text-sm px-3">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="">
                        <x-input label="Father contact number" wire:model="father_contact_number"></x-input>
                        @error('father_contact_number') <span class="text-pink-500 text-sm px-3">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="">
                        <x-input label="Mother name" wire:model="mother_name"></x-input>
                        @error('mother_name') <span class="text-pink-500 text-sm px-3">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="">
                        <x-input label="Mother contact number" wire:model="mother_contact_number"></x-input>
                        @error('mother_contact_number') <span class="text-pink-500 text-sm px-3">{{ $message }}</span>
                        @enderror
                    </div>
                    <div>
