<div>
    <div class="flex justify-end">
        <x-button onclick="Livewire.dispatch('openModal', { component: 'subject.subject-management-modal' })" class="mt-1"> Create
            Subject </x-button>
    </div>
                    ...
                    <x-table.row>
                        ...
                        <x-table.cell>
                            <div class="flex gap-x-4">
                                <button
                                    onclick="Livewire.dispatch('openModal', { component: 'subject.subject-management-modal', arguments: { subject_id: {{ $data->id }} , name: '{{$data->name}}' }})"
                                    class="">
